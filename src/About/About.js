        ...
        <div className='pt-24 m-16'>
            ...
            <div id='About' className='flex h-fit-content rounded-xl'>
                <div className='pl-8'>
                    ...
                    <p>I'm a curious and dilligent software developer with a background in Neuroscience who passionate about reverse engineering problems to find solutions. In my projects my pricipal motivation is empowering others.</p>
